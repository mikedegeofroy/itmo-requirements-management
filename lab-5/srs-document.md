...
2. ISO/IEC 25010:2011 - Системная и программная инженерия - Требования и оценка качества систем и программного обеспечения
3. ГОСТ 34.602-89 - Техническое задание на создание автоматизированной системы
4. Внутренние документы университета (учебные планы, положение об организации учебного процесса)
...
- Система должна поддерживать не менее 5000 одновременных пользователей в пиковые периоды (начало семестра, периоды сессии).
